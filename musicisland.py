...
class MiniMusicPlayer(QWidget):
    ...
    def _start_global_hotkey_listener(self):
        ...
        try:
            ...
            _watched_vks = {toggle_vk, next_vk, prev_vk, pause_vk}
    ...
    def _play_switch_sound(self):
        """Play switch.mp3 using a disposable QMediaPlayer, allowing overlapping plays."""
        try:
            if not hasattr(self, '_switch_sound_players'):
                self._switch_sound_players = []
            ...
            self._switch_sound_players.append((p, ao))

            def _on_status(status, _p=p, _ao=ao):
                # Start playback only once the media is fully loaded
                ...
                # Clean up after playback finishes
                    ...
                    try:
                        ...
                        pass
                    try:
                        self._switch_sound_players.remove((_p, _ao))
